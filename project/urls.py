...
urlpatterns += patterns('project.scipycon.talk.views',
    ...
    url(r'^%s/talks-cfp/download-slides/$' % (SCOPE_ARG_PATTERN),
...
urlpatterns += patterns('',
    ...
    url(r'^%s/about/food/$' % (SCOPE_ARG_PATTERN),
        ...
        name='scipycon_food'),
 url(r'^%s/downloads/$' % (SCOPE_ARG_PATTERN),
        direct_to_template, {"template": "downloads.html"},
        name='scipycon_downloads'),
    url(r'^%s/about/venue/$' % (SCOPE_ARG_PATTERN),
        direct_to_template, {"template": "about/venue.html"},
        name='scipycon_venue'),
    url(r'^%s/about/reachingcampus/$' % (SCOPE_ARG_PATTERN),
        direct_to_template, {"template": "about/reachingcampus.html"},
        name='scipycon_reachingcampus'),
    ...
    url(r'^%s/about/accepted/$' % (SCOPE_ARG_PATTERN),
        direct_to_template, {"template": "about/accepted_abstracts.html"},
        name='scipycon_accepted_abstracts'),
    )
